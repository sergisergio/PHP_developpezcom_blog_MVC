...
function getBillet($idBillet) {
	...
	if ($billet->rowCount() == 1)
		...
		throw new Exeption("Aucun billet ne correspond à l'identifiant '$idBillet'");
}
...
function getBdd() {
	$bdd = new PDO('mysql:host=localhost;dbname=blog_developpez_com;charset=utf8', 'root', 'root', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
	return $bdd;
}